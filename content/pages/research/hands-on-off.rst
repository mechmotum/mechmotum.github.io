...
:template: project
:summary-sentence: This research explores whether eye movements and bicycle motion can reveal how hard a cyclist is working when balancing — especially when riding with hands off the handlebars.
:summary-image: https://mechmotum.s3.us-east-005.dream.io/image-400x400-hands-off.png
:slug: research/hands-on-off
...
1. Jules Ronné, Holger Caesar, Jason K. Moore (2025). “Inferring cyclist workload using gaze metrics for bicycle balancing tasks.” *Congress of the International Society of Biomechanics (ISB 2025)*, Stockholm, Sweden.
