=========================================================================
Examining Wobble of a Bicycle on a Stabilized Treadmill Setup
=========================================================================
...
:current_researchers:
:past_researchers: Jules Ronné, Benjamin Gonzalez, Jason K. Moore
:research_theme: Bicycle Engineering
:template: project
:summary-sentence: This study develops a controlled experimental platform to investigate how component stiffness influences bicycle dynamics — particularly the stability of intrinsic vibration modes, including the well-known wobble mode — using a parametric bicycle on a stabilized treadmill.
:summary-image: https://mechmotum.s3.us-east-005.dream.io/image-400x400-wobble.png
:slug: research/wobble-treadmill
...
1. Peters, R., Verhoeff, H., Gesthuizen, K., Willemsen, B., & Bosman, T. (2025). *Examining wobble of a bicycle on a stabilized treadmill setup*. Bachelor End Project, Mechanical Engineering, Delft University of Technology. Supervised by Jules Ronné, Benjamin Gonzalez, and Jason K. Moore.
...
This project was conducted as part of the Bachelor End Project program in the Mechanical Engineering department at Delft University of Technology.  
This project was funded by a cohesion grant of TU Delft between the Inteligent vehicule group (Cognitive Robotics departement) and the Bicycle Lab (BioMechanical Engineering departement).
